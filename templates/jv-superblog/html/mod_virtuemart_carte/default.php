...
<?php if ($show_product_list) :?> 
 <button id="dLabel" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="btn btn-primary view_cart_link view_cart_link_1" data-text="<?php echo JText::_('TPL_MY_CART')?>">
    ...
    <span class="total_products"><?php echo  $data->totalProduct;?> <?php echo vmText::_('TPL_ITEMS') ?> - <span class="hidden"><?php echo str_replace('<strong>', '</span><strong>', $data->billTotal); ?></span> 
        ...
        <ul class="list-thumbs-pro">
            ...
            <li class="product">
                <div class="thumb-item">
                    ...
                    <div class="thumb-item-cont">
                        <div class="mb-5 pro-title"><?php echo  $product['product_name'] ?></div>
