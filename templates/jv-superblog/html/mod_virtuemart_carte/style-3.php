...
<?php if ($show_product_list) :?> 
 <button id="dLabel" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="btn btn-primary view_cart_link view_cart_link_3">
    <i class="fa fa-shopping-cart"></i>
    <span class="cart-label"> <?php echo vmText::_('TPL_CART') ?></span>
    <span class="text-gray">(</span><span class="total_products"><?php echo  $data->totalProduct;?></span><span class="text-gray">)</span>
    <span class="cart-item" data-text="<?php echo vmText::_('TPL_ITEMS') ?>"><?php echo vmText::_('TPL_ITEM') ?></span>
