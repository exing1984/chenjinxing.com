...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2Recent-1<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
  ...
  <ul class="list-unstyled">
    ...
    <li>
		...
		<?php if($params->get('itemTitle')): ?>
			<a class="moduleItemTitle h4" href="<?php echo $item->link; ?>"><?php echo $item->title; ?></a>
		<?php endif; ?>
