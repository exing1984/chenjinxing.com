...
<div class="portfolio-detail-default clearfix">
  <div class="row">
    <?php if ($this->item->pfo_v) { ?>
      <div class="col-md-<?php echo ($show_details)?"6":"12";?>">
      ...
      <?php if ($this->item->gallery) { ?>
        <div class="col-md-<?php echo ($show_details)?"6":"12";?>">
            <?php foreach($this->item->gallery as $i=>$path):?>
              <div class="pfo-detail-image<?php echo ($i != 0)?' mt-30':''; ?>">
        ...
        <?php } ?>
    <?php } ?>
    <div class="pt-sm-20 col-md-<?php echo ($this->item->gallery || $this->item->pfo_v)?'6':'12';?>">
