...
<article class="mb-50">
	<div class="post-body">
					...
					<?php } else{ ?>
						<?php if($this->item->params->get('catItemImage') && !empty($this->item->image)){ ?>
							...
							<div class="post-image">
							    ...
							    >
							    	<span class="slice lv1" style="background-image: url(<?php echo $this->item->image; ?>)">
							    		<span class="overlay"></span>
							    		<span class="slice lv2" style="background-image: url(<?php echo $this->item->image; ?>)">
								    		<span class="overlay"></span>
								    		<span class="slice lv3" style="background-image: url(<?php echo $this->item->image; ?>)">
									    		<span class="overlay"></span>
									    		<span class="slice lv4" style="background-image: url(<?php echo $this->item->image; ?>)">
										    		<span class="overlay"></span>
										    		<span class="slice lv5" style="background-image: url(<?php echo $this->item->image; ?>)">
											    		<span class="overlay"></span>
											    	</span>
										    	</span>
									    	</span>
				    			...
				    			<div class="post-bottomtools">
									<div class="post-bottomtools-top">
										<?php if($this->item->params->get('catItemAuthor')): ?>
										<span>
											<?php if(isset($this->item->author->link) && $this->item->author->link): ?>
											<a rel="author" href="<?php echo $this->item->author->link; ?>" title="<?php echo JText::_('TPL_BLOG_BY').' '.$this->item->author->name;?> "><?php echo JText::_('TPL_BLOG_BY').' '.$this->item->author->name; ?></a>
											<?php else: ?>
										...
										<span><a href="<?php echo $this->item->category->link; ?>" title="<?php echo JText::_('TPL_CATEGORY');?>"><?php echo JText::_('TPL_CATEGORY');?> <?php echo $this->item->category->name; ?></a></span>
										<?php endif; ?>
										<!-- End Category -->
				...
				<div class="post-content">
					...
					<?php if( ($this->item->params->get('catItemImageGallery') && !empty($this->item->gallery)) || ($this->item->params->get('catItemVideo') && !empty($this->item->video)) ){ ?>
						<div class="post-bottomtools">
