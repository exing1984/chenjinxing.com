...
$document->addScriptDeclaration('
	(function($){
		$(function(){
			$(".blog-image-left").parents("#block-main").css("background-color","#f9f9f9");
			var $video = $(".itemListView.blog-image-left .avVideo"),
			    $audio = $(".itemListView.blog-image-left .avAudio");
			    $soundCloud = $(".itemListView.blog-image-left .avSoundCloudSong");
			$video.parents(".post-image").find(".post-info-icon").addClass("video").find("i").removeClass("fa-image").addClass("fa-film");
			$audio.parents(".post-image").find(".post-info-icon").addClass("video").find("i").removeClass("fa-image").addClass("fa-music");
			$soundCloud.parents(".post-image").find(".post-info").hide();
		});
	})(jQuery);
');
?>
...
<div id="k2Container" class="itemListView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?> blog-image-left blog-image-right">
