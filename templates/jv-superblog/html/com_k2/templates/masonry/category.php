	...
	(function($){
		$(function(){
			function loadMasonry(){
				$(".blog-masonry-2 .itemList").imagesLoaded( function() {
					var $grid = $(".blog-masonry-2 .itemList");
					  $grid.shuffle({
...
<div id="k2Container" class="itemListView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?> blog-masonry-2 cols-<?php echo $this->params->get('num_leading_columns'); ?>">
	...
	<div class="row itemList mb-20">
			<?php if(isset($this->leading) && count($this->leading)): ?>
				...
				<div class="col-xxs-12 col-xs-6 col-md-<?php echo ($this->params->get('num_leading_columns') > 5)?'4':number_format(12/$this->params->get('num_leading_columns'), 0)?> col-lg-<?php echo number_format(12/$this->params->get('num_leading_columns'), 0)?> post-mansory-item">
					<?php
