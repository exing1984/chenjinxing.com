...
if ($this->categories and VmConfig::get('show_categories', 1)) echo $this->renderVmSubLayout('categories',array('categories'=>$this->categories,'categories_per_row' => $homepage_categories_per_row));
