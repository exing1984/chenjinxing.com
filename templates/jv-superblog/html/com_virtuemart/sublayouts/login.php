                  ...
                  <form action="<?php echo JRoute::_( 'index.php', 1, $this->useSSL); ?>" method="post" name="com-login" class="form-horizontal" >
                    ...
                    <div  id="com-form-order-submit" class="form-group">
                        <div class="col-sm-9 col-sm-offset-3">
                          <input type="submit" name="Submitbuton" class="btn btn-default" value="<?php echo vmText::_('COM_VIRTUEMART_ORDER_BUTTON_VIEW') ?>" />
                        </div>
                    </div>
              ...
              <form action="<?php echo JRoute::_('index.php', $this->useXHTML, $this->useSSL); ?>" method="post" name="com-login" class="form-horizontal">
                ...
                <div class="userdata">
                  <div class="form-group" id="com-form-login-username">
                    <label for="vmusername" class="col-sm-2 control-label"><?php echo vmText::_('COM_VIRTUEMART_USERNAME'); ?></label>
                    <div class="col-sm-10">
                  ...
                  <div class="form-group" id="com-form-login-password">
                    <label for="modlgn-passwd" class="col-sm-2 control-label"><?php echo vmText::_('COM_VIRTUEMART_PASSWORD'); ?></label>
                    <div class="col-sm-10">
                  ...
                  <div class="form-group" id="form-login-submit">
                    ...
                    <?php endif; ?>
                      <input type="submit" name="Submit" class="btn btn-default" value="<?php echo vmText::_('COM_VIRTUEMART_LOGIN') ?>" />
                    </div>
                  </div>
                </div>
...
<?php  
    ...
    <form action="<?php echo JRoute::_('index.php'); ?>" method="post" name="login" id="form-login" class="mb-5">
