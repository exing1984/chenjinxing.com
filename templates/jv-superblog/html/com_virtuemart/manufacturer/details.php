	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-6 col-md-8">
			...
			if(!empty($this->manufacturer->virtuemart_manufacturer_id)) { ?>
					<a target="_top" href="<?php echo $manufacturerProductsURL; ?>" class="btn btn-primary"><?php echo vmText::sprintf('COM_VIRTUEMART_PRODUCT_FROM_MF',$this->manufacturer->mf_name); ?></a>
			<?php } ?>
		</div>
	</div>
</div>