...
<div id="cart-view" class="cart-view">
	<div>
		<?php
			...
			echo '<a class="btn btn-sm btn-primary btn-continue pull-right" href="' .JRoute::_ ('index.php?option=com_virtuemart&view=category' . $categoryStr.$ItemidStr, FALSE) . '"><i class="gala-basket-stroke"></i> ' . vmText::_ ('COM_VIRTUEMART_CONTINUE_SHOPPING') . '</a>'; 
		?>
	...
	?><form method="post" id="checkoutForm" name="checkoutForm" action="<?php echo JRoute::_ ('index.php?option=com_virtuemart&view=cart' . $taskRoute, $this->useXHTML, $this->useSSL); ?>">
		...
		?> <div class="checkout-button-top"> <?php
			echo '<button type="submit"  id="checkoutFormSubmit" name="'.$this->checkout_task.'" value="1" class="btn btn-primary" ><span>' . vmText::_('COM_VIRTUEMART_CHECKOUT_TITLE'). '</span> </button>';
			?></div>
