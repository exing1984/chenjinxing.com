...
?>
<div class="clearfix featured-box">
	<div class="row">
		<div class="col-sm-6">
			<div class="featured-box-cart ">
				<div class="box-content">
					<h4><?php echo vmText::_ ('COM_VIRTUEMART_USER_FORM_BILLTO_LBL'); ?></h4>
		...
		<div class="col-sm-6">
			<div class="featured-box-cart ">
				<div class="box-content">
					<h4><?php echo vmText::_ ('COM_VIRTUEMART_USER_FORM_SHIPTO_LBL'); ?></h4>
					<?php // Output Bill To Address ?>
